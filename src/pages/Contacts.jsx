          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border-2 border-gray-200 bg-gray-50 p-3 text-gray-800 transition-all duration-200 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:focus:border-blue-400 dark:focus:bg-gray-700 sm:p-4"
              />
            ...
            <div>
              ...
              <textarea
                ...
                className="sm:rows-5 w-full resize-none rounded-xl border-2 border-gray-200 bg-gray-50 p-3 text-gray-800 transition-all duration-200 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:focus:border-blue-400 dark:focus:bg-gray-700 sm:p-4"
              ></textarea>
