...
function Sidebar() {
  return (
    <div className="row-span-full mt-4 px-4 py-6 lg:mt-10 lg:px-6 dark:from-gray-800 dark:to-gray-900">
      <div className="flex justify-center">
        <div className="w-full max-w-sm rounded-2xl bg-white p-4 shadow-xl transition-all duration-300 hover:shadow-2xl sm:p-6 lg:w-[276px] lg:p-8 dark:bg-gray-700">
          ...
          <div className="mb-4 text-center lg:mb-6">
            <h1 className="mb-2 text-lg font-bold text-gray-800 sm:text-xl lg:text-2xl dark:text-white">
              Junaid Ali Shah
            </h1>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="group flex items-center gap-3 rounded-xl p-2 transition-all duration-200 hover:bg-gray-50 sm:gap-4 sm:p-3 dark:hover:bg-gray-600">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-red-500 to-pink-600 shadow-md transition-transform duration-200 group-hover:scale-110 sm:h-12 sm:w-12">
                <MdEmail className="text-base text-white sm:text-lg sm:w-[46px]" />
              </div>
              <div className="flex-1 min-w-0">
                ...
                <a
                  ...
                  className="block truncate text-xs font-medium text-gray-800 transition-colors duration-200 hover:text-blue-600 sm:text-sm dark:text-gray-200 dark:hover:text-blue-400"
                >
            ...
            <div className="group flex items-center gap-3 rounded-xl p-2 transition-all duration-200 hover:bg-gray-50 sm:gap-4 sm:p-3 dark:hover:bg-gray-600">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="text-xs font-medium text-gray-800 transition-colors duration-200 hover:text-green-600 sm:text-sm dark:text-gray-200 dark:hover:text-green-400"
                >
                  WhatsApp Me
                </a>
              </div>
            ...
            <div className="group flex items-center gap-3 rounded-xl p-2 transition-all duration-200 hover:bg-gray-50 sm:gap-4 sm:p-3 dark:hover:bg-gray-600">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-medium text-gray-800 transition-colors duration-200 hover:text-orange-600 sm:text-sm dark:text-gray-200 dark:hover:text-orange-400"
                >
                  Peshawar, Pakistan
                </a>
              </div>
          ...
          <div className="mt-6 flex justify-center space-x-3 sm:space-x-4 lg:mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-gray-800 text-white shadow-md transition-all duration-200 hover:scale-110 hover:bg-gray-700 sm:h-12 sm:w-12 dark:bg-gray-600 dark:hover:bg-gray-500"
            >
