            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="mb-3 flex flex-wrap gap-1 sm:mb-4 sm:gap-2">
                {project.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700 sm:px-3 dark:bg-blue-900/30 dark:text-blue-300"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex gap-2 sm:gap-3">
                <a
                  ...
                  className="flex items-center gap-1 rounded-xl bg-gray-800 px-3 py-2 text-xs font-medium text-white transition-all duration-200 hover:bg-gray-700 sm:gap-2 sm:px-4 sm:text-sm dark:bg-gray-600 dark:hover:bg-gray-500"
                >
